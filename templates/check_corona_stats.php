...
$def[1] .= "GPRINT:$ACT[2]:LAST:\"%2.2lf ".$UNIT[2]." curr\" ";
$def[1] .= "GPRINT:$ACT[2]:MAX:\"%2.2lf ".$UNIT[2]." max\" ";
$def[1] .= "GPRINT:$ACT[2]:MIN:\"%2.2lf ".$UNIT[2]." min\\n\" ";

$def[1] .= "DEF:$ACT[3]=$RRDFILE[3]:$DS[3]:AVERAGE ";
$def[1] .= "AREA:$ACT[3]#99ff99:\"$NAME[3]\t\" ";
$def[1] .= "GPRINT:$ACT[3]:LAST:\"%2.2lf ".$UNIT[3]." curr\" ";
$def[1] .= "GPRINT:$ACT[3]:MAX:\"%2.2lf ".$UNIT[3]." max\" ";
$def[1] .= "GPRINT:$ACT[3]:MIN:\"%2.2lf ".$UNIT[3]." min\\n\" ";
